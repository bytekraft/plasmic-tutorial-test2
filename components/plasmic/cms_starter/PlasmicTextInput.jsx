...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: K9ZFSgMmhAeT/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__vUkca)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__hVNb0)}
              role={"img"}
            />
          ),
